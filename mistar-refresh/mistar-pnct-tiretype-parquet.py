...
#
#    Work Item:   mistar-pnct-tiretype-parquet.py
#
#    Purpose:     Spark job that pulls in PNCT data from
#				  staging combined and populates tiretype parquet table.
#
...
spark = SparkSession.builder.appName('tiretype').config("hive.metastore.client.factory.class", "com.amazonaws.glue.catalog.metastore.AWSGlueDataCatalogHiveClientFactory").enableHiveSupport().getOrCreate()
...
spark.sql("MSCK REPAIR TABLE "+databaseName2+".tiretype")